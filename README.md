...
| ---------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| -                                        |  -                                      | [Intro to Ruby Programming][7-3A]       | [OOP in Ruby][7-4A]                     | [R-Lab: Ruby Apartments][7-4C]          |
| -                                        |  -                                      | [Control Flow in Ruby][7-3B]            | [ILab: Rails Medieval Objects][7-4B]    | [Intro to Relation DB][7-5A]            |
| LUNCH                                    |  LUNCH                                  | LUNCH                                   | LUNCH                                   | LUNCH                                   |
| -                                        |  -                                      | [Arrays, Hashes & Blocks][7-3C]         | [HLab: Ruby Apartments][7-4C]           | [ILab: ERD Design][7-5B]                |
| -                                        |  -                                      | [ILab: Arrays & Hashes][7-3D]           | -                                       | [SQL: Setup & CRUD][7-5C]               |
| -                                        |  -                                      | [HLab: Ruby Koans][7-3E]                | -                                       | [HLab: Find Carmen Sandiego][7-5D]      |

[7-3A]: 06-ruby/ruby-data-types-variables-lesson                                     "Intro to Ruby - Data Types & Variables"
[7-3B]: 06-ruby/ruby-control-flow-lesson                                             "Control flow in Ruby"
[7-3C]: 06-ruby/ruby-arrays-hashes-and-blocks-lesson                                 "Arrays, Hashes, & Blocks"
[7-3D]: https://github.com/wdi-hk-12/lab-ruby-arrays-and-hashes                      "ILab: Arrays & Hashes"
[7-3E]: https://github.com/wdi-hk-12/ruby_koans                                      "HLab: Ruby Koans"

[7-4A]: 06-ruby/ruby-oop-classes                                                     "OOP in Ruby"
[7-4B]: https://github.com/wdi-hk-12/lab-ruby-medieval-objects                       "ILab: Rails Medieval Objects"
[7-4C]: https://github.com/wdi-hk-12/lab-ruby-apartments                             "HLab: Ruby Apartments"
...
[8-2A]: 07-rails/rails-mvc-lesson                                                    "What is MVC?"
[8-2B]: 07-rails/rails-intro-lesson                                                  "Intro to Rails"
[8-2C]: 07-rails/rails-activerecord-modeling-relationships-lesson                    "Modeling Relationships"
[8-2D]: https://github.com/wdi-hk-12/lab-rails-relationships                         "ILab: Modeling Relationships"
[8-2E]: guides/rails/gems/faker                                                      "Seed & Faker"
